 ...
 * required this information will be retrieved from the first undo record of the
 * page.
 */
typedef struct UndoCompressionInfo
{
	bool		valid;			/* do we have valid compression info.  */
	BlockNumber blkno;			/* last undo record block number. */
	RmgrId		rmid;			/* rmgr ID */
